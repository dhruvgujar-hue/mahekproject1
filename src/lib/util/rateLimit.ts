...
const rateLimitConfigs = {
  ...
  // Try-on can be triggered repeatedly while styling (multiple clothing pieces/layers)
  // so keep a higher dedicated cap than generic AI operations.
  tryOn: { rate: 60, interval: 5 * 60_000 },
