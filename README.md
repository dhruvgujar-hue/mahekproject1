...
printf "OPENAI_API_KEY=\n# Optional: RAPIDAPI_KEY=\n# Optional: RAPIDAPI_HOST=real-time-amazon-data.p.rapidapi.com\n# Optional: FASHN_AI_API_KEY=\n# Optional overrides\n# OPENAI_BASE_URL=https://api.openai.com\n# KLING_ACCESS_KEY=\n# KLING_SECRET_KEY=\n" > .env.local
...
# Optional: Amazon via RapidAPI (shopping search)
# If omitted, you can still upload your own clothing images in the Shopping panel.
# RAPIDAPI_KEY=your_rapidapi_key
# RAPIDAPI_HOST=real-time-amazon-data.p.rapidapi.com

# Optional: FASHN AI (higher-fidelity virtual try-on)
# If omitted, /api/tryon falls back to OpenAI-only try-on.
...
- Optional: `RAPIDAPI_KEY`, `RAPIDAPI_HOST=real-time-amazon-data.p.rapidapi.com`, `FASHN_AI_API_KEY`.
